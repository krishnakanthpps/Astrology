...
public class APIUrl {
    ...
    public static final String API_GET_TOKEN = "http://expertwebworx.in/astro-paypal/main.php";
    public static final String API_CHECK_OUT = "http://expertwebworx.in/astro-paypal/checkout.php";
}
